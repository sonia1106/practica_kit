...
<header
	class={`
    z-30 flex w-full flex-col border-b transition-colors duration-300
    ${$dark ? 'bg-gray-900 border-gray-700 text-gray-100' : 'bg-white border-gray-200 text-gray-700'}
  `}
>
	<div class="lg:flex-row lg:px-6 flex grow flex-col items-center justify-between">
		<div
			class="gap-2 px-3 py-3 sm:gap-4 lg:justify-normal lg:px-0 lg:py-4 dark:border-gray-900 flex w-full items-center justify-between"
		>
			...
			<button
				...
				class={`
          h-11 w-11 rounded-lg lg:border z-50 flex items-center
          justify-center border-0
          ${$dark ? 'text-gray-400 border-gray-800' : 'text-gray-500 border-gray-200'}
        `}
			>
				{#if $sidebarOpen}
					<!-- ICONO X (solo visible en mobile) -->
					<svg
						class="lg:hidden w-5 h-5 block"
						viewBox="0 0 24 24"
						fill="none"
						stroke="currentColor"
						stroke-width="2"
				...
				{/if}
				<svg
					class={`w-4 h-4 fill-current ${$sidebarOpen ? 'lg:block hidden' : 'block'}`}
					viewBox="0 0 16 12"
			...
			<a href="/dashboard" class="lg:hidden flex">
				<div
					class="w-8 h-8 bg-blue-500 rounded-lg mr-2 text-white font-bold flex items-center justify-center"
				>
					P
				</div>
			...
			<div class="lg:block hidden">
				<form>
					<div class="max-w-md relative mx-auto w-full">
						<span
							class={`left-3 absolute top-1/2 -translate-y-1/2 ${dark ? 'text-gray-400' : 'text-gray-500'}`}
						>
							<svg
		...
		<!-- 𝗜𝗰𝗼𝗻𝗼𝘀 𝗱𝗲𝗹 𝗵𝗲𝗮𝗱𝗲𝗿 -->
		<div
			class={`lg:flex-row lg:items-center lg:justify-end gap-4 flex w-full flex-col items-start justify-between 
          ${$dark ? 'bg-gray-900 border-gray-800 text-gray-100' : 'bg-white border-gray-200 text-gray-700'}
          ${
						openMenu.icon_resp
							? 'left-0 shadow-md lg:shadow-none lg:static lg:w-auto absolute top-full flex'
							: 'lg:flex hidden'
					}
        `}
		>
          ...
          `}
			>
				<div class="2xsm:gap-3 gap-2 flex items-center">
					<!-- Modo oscuro -->
					<button
						class={`h-11 w-11 relative flex items-center justify-center rounded-full border
                        ${
													$dark
					...
					<div class="notification-wrapper relative">
						...
						>
							{#if notifying}
								<span
									class="hiden top-0.5 right-0 h-2 w-2 bg-orange-400 absolute z-1 flex rounded-full"
								>
									<span
										class="animate-ping bg-orange-400 absolute -z-1 inline-flex h-full w-full rounded-full opacity-75"
									></span>
								</span>
							{/if}
									...
									<li>
										...
										>
											<span class="h-10 w-10 relative z-1 block rounded-full">
												...
												/>
												<span
													class="bg-success-500 right-0 bottom-0 h-2.5 w-2.5 border-gray-800 absolute z-10 rounded-full border-2"
												></span>
											</span>
											<div class="flex-1">
												<p
									...
									<li>
										...
										>
											<span class="h-10 w-10 relative z-1 block rounded-full">
												...
												/>
												<span
													class="bg-error-500 right-0 bottom-0 h-2.5 w-2.5 border-gray-800 absolute z-10 rounded-full border-2"
												></span>
											</span>
											<div class="flex-1">
												<p
				...
				<!-- 👤 Usuario -->
				<div class="user-wrapper relative">
					<button
						type="button"
                ...
                ${$dark ? 'text-gray-300' : 'text-gray-500'}`}
					...
					>
						<div class="flex items-center">
							...
							<p
								class={`text-sm mr-1 font-medium block 
							...
							<svg
								...
								fill="none"
								xmlns="http://www.w3.org/2000/svg"
								class={`stroke-2 transition-transform 
					...
					{#if openMenu.usuario}
						...
						>
							...
							<!-- Opciones -->
							<ul
								class={`gap-1 pt-4 pb-3 flex flex-col border-b 
							...
							>
								...
								<li>
									<a
										href="profile.html"
										class={`group text-sm gap-3 rounded-lg px-3 py-2 font-medium flex items-center 
                                ${
																	$dark
